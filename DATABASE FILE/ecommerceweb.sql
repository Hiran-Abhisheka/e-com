...
(1, 'How to find an item?', '<p>Content here...</p>'),
(2, 'What is your return policy?', '<p>Content here...</p>'),
(3, 'I received a defective/damaged item, can I get a refund?', '<p>Content here...</p>'),
(4, 'When are \'Returns\' not possible?', '<p class=\"a\">There are a few certain scenarios where it is difficult for us to support returns:</p><ol><li>Return request is made outside the specified time frame, of 15 days from delivery.</li><li>Product is used, damaged, or is not in the same condition as you received it.</li></ol>'),
