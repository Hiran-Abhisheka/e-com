...
if (isset($_POST['form1'])) {
    ...
    if($valid == 1) {
        ...
        // Provide a default value if cust_b_country is empty
        $cust_b_country = empty($_POST['cust_b_country']) ? 0 : $_POST['cust_b_country'];
        $cust_s_country = empty($_POST['cust_s_country']) ? 0 : $_POST['cust_s_country'];
        ...
        $statement->execute(array(
                                        ...
                                        '', // cust_b_cname
                                        '', // cust_b_phone
                                        $cust_b_country, // Use the default value if empty
                                        '', // cust_b_address
                                        '', // cust_b_city
                                        '', // cust_b_state
                                        '', // cust_b_zip
                                        ...
                                        '', // cust_s_cname
                                        '', // cust_s_phone
                                        $cust_s_country, // Use the default value if empty
                                        '', // cust_s_address
                                        '', // cust_s_city
                                        '', // cust_s_state
                                        '', // cust_s_zip
